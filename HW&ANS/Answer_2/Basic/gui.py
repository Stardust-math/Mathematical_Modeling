...
class RPCAApp:
    ...
    def _draw_original(self):
        ...
        gray = self.restorer.gray

        if original.ndim == 2:
            ax1.imshow(original, cmap="gray", vmin=0.0, vmax=1.0)
        else:
            ax1.imshow(original)
        ...
        ax2.imshow(gray, cmap="gray", vmin=0.0, vmax=1.0)
        ax2.set_title("Input Matrix (Gray)", fontsize=11)
        ax2.axis("off")
    ...
    def _draw_result(self, result: dict):
        ...
        ax2.imshow(gray, cmap="gray", vmin=0.0, vmax=1.0)
        ax2.set_title("Input Matrix", fontsize=11)
        ax2.axis("off")

        ax3.imshow(low_rank, cmap="gray", vmin=0.0, vmax=1.0)
        ax3.set_title("Low-rank Part L", fontsize=11)
        ax3.axis("off")

        ax4.imshow(sparse, cmap="gray", vmin=0.0, vmax=1.0)
        ax4.set_title("Sparse Part S", fontsize=11)
        ax4.axis("off")
