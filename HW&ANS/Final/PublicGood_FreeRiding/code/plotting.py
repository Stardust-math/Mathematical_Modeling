...
# Numbered aliases used by the LaTeX paper.  The original analytical figure
# names are kept for traceability, while these aliases make the Python output
# reproduce the exact figure names cited in the current manuscript.
_PAPER_FIGURE_ALIASES = {
    'figs/paper/model_framework': 'figs/paper/fig01_model_framework',
    'figs/synthetic/synthetic_scenario_dashboard': 'figs/paper/fig02_scenario_dashboard',
    'figs/synthetic/synthetic_nash_social_comparison': 'figs/paper/fig03_nash_social_comparison',
    'figs/synthetic/synthetic_welfare_loss_decomposition': 'figs/paper/fig04_welfare_loss_decomposition',
    'figs/synthetic/synthetic_policy_comparison': 'figs/paper/fig05_policy_comparison',
    'figs/synthetic/synthetic_policy_decision_matrix': 'figs/paper/fig06_policy_decision_matrix',
    'figs/synthetic/synthetic_pareto_front': 'figs/paper/fig07_pareto_front',
    'figs/synthetic/synthetic_monte_carlo_uncertainty': 'figs/paper/fig08_monte_carlo_uncertainty',
    'figs/paper/causal_loop_diagram': 'figs/paper/fig09_causal_loop_diagram',
    'figs/synthetic/synthetic_contribution_distribution': 'figs/paper/fig10_contribution_distribution',
    'figs/synthetic/synthetic_nash_vs_social_trajectory': 'figs/paper/fig11_nash_social_trajectory',
    'figs/synthetic/synthetic_monte_carlo_welfare_uncertainty_band': 'figs/paper/fig15_monte_carlo_welfare_band',
}


def _save(fig, relpath_no_ext: str, dpi: int = 450):
    # Use tighter padding for numbered paper figures so the output can be used
    # directly by the LaTeX manuscript without a separate manual copy step.
    targets = [relpath_no_ext]
    alias = _PAPER_FIGURE_ALIASES.get(relpath_no_ext)
    ...
    for target in targets:
        ...
        pad = 0.012 if target.startswith('figs/paper/') else 0.022
        # The paper uses PDF figures; PNG and SVG are still exported for quick
        # visual checks and web/report reuse.
