        ...
        for shape in ["s_curve", "circle", "ellipse", "sine_modulated"]:
            ...
            for method in ALL_METHODS:
                ...
                fig = plot_points_and_curve(
                    ...
                    closed=closed,
                    save_path=self.figures_dir / "no_noise_basic" / f"{shape}_{method}.png",
                )
            ...
            fig = plot_method_comparison(
                ...
                closed=closed,
                save_path=self.figures_dir / "no_noise_basic" / f"{shape}_comparison.png",
            )
            import matplotlib.pyplot as plt
            plt.close(fig)
            ...
            fig = plot_local_zoom(
                ...
                closed=closed,
                save_path=self.figures_dir / "no_noise_basic" / f"{shape}_local_zoom.png",
            )
            plt.close(fig)
    ...
    def run_parameterization_comparison(self):
        ...
        for shape in ["sine_modulated", "ellipse", "cardioid"]:
            ...
            fig = plot_parameterization_comparison(
                ...
                closed=closed,
                save_path=self.figures_dir / "parameterization" / f"{shape}_parameterization_comparison.png",
            )
            import matplotlib.pyplot as plt
            plt.close(fig)
        df = pd.DataFrame(rows)
    ...
    def run_node_count_experiment(self):
        ...
        for shape in df["shape"].unique():
            ...
            fig = plot_line_chart(
                ...
                save_path=self.figures_dir / "node_count" / f"{shape}_node_count_vs_error.png",
            )
            plt.close(fig)
            fig = plot_line_chart(
                sub,
                ...
                save_path=self.figures_dir / "node_count" / f"{shape}_node_count_vs_runtime.png",
            )
            plt.close(fig)
        return df
    ...
    def run_noise_robustness_experiment(self):
        ...
        for shape in df["shape"].unique():
            ...
            fig = plot_line_chart(
                ...
                save_path=self.figures_dir / "noise_robustness" / f"{shape}_noise_vs_error.png",
            )
            plt.close(fig)
            ...
            fig = plot_boxplot(
                ...
                save_path=self.figures_dir / "noise_robustness" / f"{shape}_error_boxplot.png",
            )
            plt.close(fig)
            fig = plot_violinplot(
                box_df,
                ...
                save_path=self.figures_dir / "noise_robustness" / f"{shape}_error_violin.png",
            )
            plt.close(fig)
        return df
